<div>
    <div class="relative min-h-screen md:flex">
        <div class="absolute w-full top-1/3 z-20 text-main-text text-center space-y-4">
            <h1 class="font-playfair text-4xl xl:text-6xl uppercase">
                Thodoris <span class="text-decoration font-extrabold">Nikolaidis</span>
            </h1>
            <p class="font-roboto text-main-200 text-lg xl:text-3xl">I am a Full Stack Developer</p>
        </div>
        <div
